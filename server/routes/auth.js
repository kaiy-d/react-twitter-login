...
router.route('/followers')
    .get(function (req, res, next) {
        ...
        var apiUrl = "https://api.twitter.com/1.1/followers/list.json" + "?"
            + qs.stringify({user_id: id, count: 200});
        ...
        request.get({url: apiUrl, oauth: authenticationData, json: true}, function (err, r, body) {
            ...
            for (let i in body.users) {
                var followerObj = {
                    ...
                    bio: body.users[i].description,
                    location: body.users[i].location,
                    tess: body.users[i].url,
                    follow: body.users[i].friends_count,
                    friends: body.users[i].followers_count
                }
    ...
    .get(function (req, res, next) {
        ...
        var apiUrl = "https://api.twitter.com/1.1/friends/list.json" + "?"
